          ...
          <div style={styles.creditCard}>
            ...
            <div style={styles.creditResults}>
              <div style={styles.creditRow}>
                ...
                <strong style={{ color: "var(--tx1)" }}>{fmtFull(montos.bancoestado)}</strong>
              </div>
              <div style={styles.creditRow}>
              ...
              <div style={styles.creditRow}>
                ...
                <strong style={{ color: "var(--tx1)" }}>{fmtFull(calc.costoTotalCredito)}</strong>
              </div>
            </div>
          ...
          <div style={styles.timelineCard}>
            ...
            <div style={styles.tipCard}>
              ...
              <div style={styles.tipText}>
                ...
                <strong style={{ color: "var(--tx2)" }}> $2M capital propio</strong>.<br/><br/>
...
const styles = {
  ...
  inputCard: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 14, marginBottom: "1rem" },
  summaryCard: { background: "linear-gradient(135deg, rgba(251,191,36,0.06), var(--card))", border: "1px solid rgba(251,191,36,0.2)", borderRadius: 14, padding: "1rem" },
  summaryRow: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginBottom: "0.75rem" },
  summaryLabel: { fontSize: 9, color: "var(--tx2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 },
  summaryValue: { fontSize: 18, fontWeight: 800, fontVariantNumeric: "tabular-nums", lineHeight: 1 },
  stackBar: { height: 12, background: "var(--bdr)", borderRadius: 4, overflow: "hidden", display: "flex", marginBottom: 10 },
  legend: { display: "flex", flexDirection: "column", gap: 4 },
  legendItem: { display: "flex", alignItems: "center", gap: 6, fontSize: 11 },
  legendDot: { width: 8, height: 8, borderRadius: 2 },
  legendName: { flex: 1, color: "var(--tx2)" },
  legendValue: { color: "var(--tx1)", fontWeight: 700, fontVariantNumeric: "tabular-nums" },
  ...
  instCard: { background: "var(--card)", border: "1px solid", borderRadius: 12, padding: "1rem" },
  instHeader: { display: "flex", alignItems: "flex-start", gap: 12, marginBottom: 10 },
  instName: { fontSize: 14, fontWeight: 800 },
  instType: { fontSize: 10, color: "var(--tx2)", marginTop: 2 },
  instMax: { display: "flex", flexDirection: "column", alignItems: "flex-end" },
  instMaxLabel: { fontSize: 9, color: "var(--tx2)", textTransform: "uppercase" },
  ...
  reqItem: { fontSize: 11, color: "var(--tx2)", paddingLeft: 14, position: "relative", lineHeight: 1.5 },
  noteBox: { fontSize: 11, color: "var(--tx1)", background: "var(--ibg)", padding: "8px 10px", marginTop: "0.85rem", borderRadius: 4, lineHeight: 1.5 },
  ...
  sliderLabel: { fontSize: 12, color: "var(--tx1)" },
  sliderValue: { fontSize: 14, fontWeight: 700, fontVariantNumeric: "tabular-nums" },
  slider: { width: "100%", cursor: "pointer", height: 4 },
  creditCard: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: "1rem" },
  creditTitle: { fontSize: 13, fontWeight: 700, color: "var(--tx1)", marginBottom: 4 },
  creditSliders: { display: "flex", flexDirection: "column", gap: 14 },
  creditResults: { background: "var(--ibg)", borderRadius: 8, padding: "0.85rem" },
  creditRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "6px 0", fontSize: 13 },
  creditLabel: { color: "var(--tx2)" },
  ...
  timelineCard: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: "1rem" },
  ...
  timelineLine: { flex: 1, width: 2, background: "var(--bdr)", marginTop: 4 },
  timelineRight: { flex: 1, paddingTop: 8 },
  timelineFase: { fontSize: 13, color: "var(--tx1)", fontWeight: 600 },
};

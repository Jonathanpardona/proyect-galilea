  ...
  return (
    <div style={styles.newForm}>
      <div style={styles.newFormHeader}>
        <strong style={{ fontSize: 13, color: "var(--tx1)" }}>Nuevo retiro</strong>
...
const styles = {
  ...
  kpi: { flex: 1, background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 10, padding: "0.7rem" },
  ...
  newForm: { background: "var(--card)", border: "1px solid #fbbf24", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 10 },
  ...
  fieldInput: { background: "var(--ibg)", border: "1px solid var(--bdr2)", borderRadius: 6, padding: "8px 10px", color: "var(--tx1)", fontSize: 13, outline: "none", fontFamily: "inherit", width: "100%", boxSizing: "border-box", colorScheme: "dark" },
  ...
  addRowBtn: { background: "transparent", border: "1px dashed var(--bdr2)", borderRadius: 6, padding: "6px 12px", fontSize: 11, color: "var(--tx2)", cursor: "pointer", fontFamily: "inherit" },
  totalRow: { textAlign: "right", fontSize: 13, color: "var(--tx1)", paddingTop: 6, borderTop: "1px solid var(--bdr)" },
  ...
  card: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 10, padding: "0.85rem 1rem" },
  cardTop: { display: "flex", justifyContent: "space-between", marginBottom: 8 },
  cardDate: { fontSize: 14, fontWeight: 800, color: "var(--tx1)" },
  cardMeta: { fontSize: 11, color: "var(--tx2)", marginTop: 2 },
  ...
  confirmNo: { background: "transparent", border: "1px solid var(--bdr2)", borderRadius: 5, padding: "4px 10px", fontSize: 11, color: "var(--tx2)", cursor: "pointer", fontFamily: "inherit" },
  configCard: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 10 },

  ...
  return (
    <div style={styles.newForm}>
      <div style={styles.newFormHeader}>
        <strong style={{ fontSize: 13, color: "var(--g-text)" }}>Nuevo retiro</strong>
...
const styles = {
  ...
  kpi: { flex: 1, background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 10, padding: "0.7rem" },
  ...
  newForm: { background: "var(--g-surface)", border: "1px solid #fbbf24", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 10 },
  ...
  fieldInput: { background: "var(--g-input-bg)", border: "1px solid var(--g-border)", borderRadius: 6, padding: "8px 10px", color: "var(--g-text)", fontSize: 13, outline: "none", fontFamily: "inherit", width: "100%", boxSizing: "border-box", colorScheme: "light dark" },
  ...
  addRowBtn: { background: "transparent", border: "1px dashed var(--g-border)", borderRadius: 6, padding: "6px 12px", fontSize: 11, color: "var(--g-text-muted)", cursor: "pointer", fontFamily: "inherit" },
  totalRow: { textAlign: "right", fontSize: 13, color: "var(--g-text)", paddingTop: 6, borderTop: "1px solid var(--g-surface)" },
  saveBtn: { background: "#fbbf24", border: "none", borderRadius: 6, padding: "10px 14px", fontSize: 13, color: "var(--g-surface)", cursor: "pointer", fontWeight: 700, fontFamily: "inherit", marginTop: 6 },
  ...
  card: { background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 10, padding: "0.85rem 1rem" },
  cardTop: { display: "flex", justifyContent: "space-between", marginBottom: 8 },
  cardDate: { fontSize: 14, fontWeight: 800, color: "var(--g-text)" },
  cardMeta: { fontSize: 11, color: "var(--g-text-muted)", marginTop: 2 },
  ...
  confirmNo: { background: "transparent", border: "1px solid var(--g-border)", borderRadius: 5, padding: "4px 10px", fontSize: 11, color: "var(--g-text-muted)", cursor: "pointer", fontFamily: "inherit" },
  configCard: { background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 10 },

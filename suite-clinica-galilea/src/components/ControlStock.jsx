      ...
      <main style={styles.main}>
        ...
        <div style={styles.itemList}>
          {filtered.map((it) => {
            ...
            const labels = { critico: "CRÍTICO", bajo: "BAJO", atento: "OK", ok: "OK" };
            return (
...
const styles = {
  ...
  bg: { position: "fixed", inset: 0, background: "radial-gradient(ellipse 70% 50% at 20% 0%, #3a2a0a 0%, transparent 60%)", pointerEvents: "none", zIndex: 0 },

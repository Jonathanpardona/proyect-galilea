...
const styles = {
  ...
  filterChip: { background: "var(--card)", border: "1px solid var(--bdr2)", borderRadius: 20, padding: "5px 12px", fontSize: 11, color: "var(--tx2)", cursor: "pointer", fontFamily: "inherit" },
  ...
  ocProv: { paddingBottom: 8, marginBottom: 8, borderBottom: "1px solid var(--bdr)" },
  ocProvHeader: { display: "flex", justifyContent: "space-between", marginBottom: 6, fontSize: 12 },
  ocItem: { display: "flex", justifyContent: "space-between", fontSize: 11, color: "var(--tx2)", padding: "2px 0" },
  itemList: { display: "flex", flexDirection: "column", gap: 6 },
  itemCard: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 10, padding: "0.75rem 0.9rem", cursor: "pointer" },
  itemTop: { display: "flex", alignItems: "center", gap: 10, marginBottom: 8 },
  itemName: { fontSize: 13, fontWeight: 700, color: "var(--tx1)", marginBottom: 2 },
  itemMeta: { fontSize: 11, color: "var(--tx2)" },
  statusTag: { fontSize: 9, fontWeight: 800, padding: "3px 7px", borderRadius: 4, border: "1px solid", flexShrink: 0 },
  stockBar: { height: 4, background: "var(--bdr)", borderRadius: 2, overflow: "hidden" },
  ...
  closeBtn: { background: "none", border: "none", color: "var(--tx2)", fontSize: 24, cursor: "pointer", padding: 0, lineHeight: 1 },
  ...
  newForm: { background: "var(--card)", border: "1px solid #34d399", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 8 },
  ...
  cancelBtn: { background: "transparent", border: "1px solid var(--bdr2)", borderRadius: 6, padding: "6px 12px", fontSize: 11, color: "var(--tx2)", cursor: "pointer", fontFamily: "inherit" },
};

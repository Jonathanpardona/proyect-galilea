...
const styles = {
  ...
  bg: { position: "absolute", inset: 0, background: "radial-gradient(ellipse 70% 50% at 20% 0%, rgba(251,191,36,0.10) 0%, transparent 60%)", pointerEvents: "none", zIndex: 0 },
  ...
  filterChip: { background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 20, padding: "5px 12px", fontSize: 11, color: "var(--g-text-muted)", cursor: "pointer", fontFamily: "inherit" },
  ...
  ocProv: { paddingBottom: 8, marginBottom: 8, borderBottom: "1px solid var(--g-surface)" },
  ocProvHeader: { display: "flex", justifyContent: "space-between", marginBottom: 6, fontSize: 12 },
  ocItem: { display: "flex", justifyContent: "space-between", fontSize: 11, color: "var(--g-text)", padding: "2px 0" },
  itemList: { display: "flex", flexDirection: "column", gap: 6 },
  itemCard: { background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 10, padding: "0.75rem 0.9rem", cursor: "pointer" },
  itemTop: { display: "flex", alignItems: "center", gap: 10, marginBottom: 8 },
  itemName: { fontSize: 13, fontWeight: 700, color: "var(--g-text)", marginBottom: 2 },
  itemMeta: { fontSize: 11, color: "var(--g-text-muted)" },
  statusTag: { fontSize: 9, fontWeight: 800, padding: "3px 7px", borderRadius: 4, border: "1px solid", flexShrink: 0 },
  stockBar: { height: 4, background: "var(--g-border)", borderRadius: 2, overflow: "hidden" },
  ...
  closeBtn: { background: "none", border: "none", color: "var(--g-text-muted)", fontSize: 24, cursor: "pointer", padding: 0, lineHeight: 1 },
  ...
  newForm: { background: "var(--g-surface)", border: "1px solid #34d399", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 8 },
  saveBtn: { background: "#34d399", border: "none", borderRadius: 6, padding: "8px 14px", fontSize: 12, color: "var(--g-surface)", cursor: "pointer", fontWeight: 700, fontFamily: "inherit" },
  cancelBtn: { background: "transparent", border: "1px solid var(--g-border)", borderRadius: 6, padding: "6px 12px", fontSize: 11, color: "var(--g-text-muted)", cursor: "pointer", fontFamily: "inherit" },
};

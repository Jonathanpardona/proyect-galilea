  ...
  return (
    <button style={styles.card} onClick={onClick}>
      ...
      <div style={styles.cardFooter}>
        <span style={{ fontSize: 10, color: "var(--tx2)" }}>{prospect.employees} trab.</span>
...
const styles = {
  ...
  viewToggle: { display: "flex", background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 8, padding: 3 },
  viewBtn: { background: "transparent", border: "none", padding: "5px 10px", fontSize: 11, color: "var(--tx2)", cursor: "pointer", borderRadius: 5, fontFamily: "inherit" },
  viewBtnActive: { background: "rgba(56,189,248,0.15)", color: "#38bdf8" },
  filterRow: { display: "flex", gap: 6, overflowX: "auto", paddingBottom: 4 },
  filterChip: { background: "var(--card)", border: "1px solid var(--bdr2)", borderRadius: 20, padding: "5px 12px", fontSize: 11, color: "var(--tx2)", cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0, fontFamily: "inherit" },
  ...
  stageCol: { minWidth: 200, maxWidth: 220, flexShrink: 0, background: "var(--card)", borderRadius: 10, padding: 10 },
  stageHeader: { paddingTop: 8, paddingBottom: 10, marginBottom: 8, borderBottom: "1px solid var(--bdr)" },
  stageHeaderTop: { display: "flex", alignItems: "center", gap: 6 },
  stageIcon: { fontSize: 14 },
  stageName: { fontSize: 12, fontWeight: 700, flex: 1 },
  stageCount: { fontSize: 11, color: "var(--tx2)", background: "var(--ibg)", borderRadius: 10, padding: "1px 7px", fontWeight: 700 },
  stageValue: { fontSize: 10, color: "var(--tx2)", marginTop: 4, fontVariantNumeric: "tabular-nums" },
  stageList: { display: "flex", flexDirection: "column", gap: 6 },
  card: { background: "var(--ibg)", border: "1px solid var(--bdr)", borderRadius: 8, padding: "0.7rem", cursor: "pointer", textAlign: "left", color: "inherit", fontFamily: "inherit", position: "relative" },
  cardCompany: { fontSize: 12, fontWeight: 700, color: "var(--tx1)", marginBottom: 2 },
  cardContact: { fontSize: 10, color: "var(--tx2)", marginBottom: 6 },
  ...
  listRow: { display: "flex", alignItems: "center", gap: 10, padding: "0.75rem 0.9rem", background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 10, cursor: "pointer" },
  ...
  listCompany: { fontSize: 13, fontWeight: 700, color: "var(--tx1)" },
  listMeta: { fontSize: 11, color: "var(--tx2)", marginTop: 2 },
  listValue: { fontSize: 13, fontWeight: 800, color: "#34d399", fontVariantNumeric: "tabular-nums", flexShrink: 0 },
  empty: { textAlign: "center", padding: "2rem", color: "var(--tx2)", fontSize: 12 },
  ...
  modal: { background: "var(--ibg)", border: "1px solid var(--bdr2)", borderRadius: "14px 14px 0 0", width: "100%", maxWidth: 560, maxHeight: "92vh", overflowY: "auto" },
  modalHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem 1.25rem", borderBottom: "1px solid var(--bdr)", position: "sticky", top: 0, background: "var(--ibg)", zIndex: 1 },
  modalTitle: { fontSize: 15, fontWeight: 700, color: "var(--tx1)", margin: 0 },
  closeBtn: { background: "none", border: "none", color: "var(--tx2)", fontSize: 24, cursor: "pointer", padding: 0, lineHeight: 1, width: 28, height: 28 },
  ...
  fieldLabel: { fontSize: 10, color: "var(--tx2)", textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 600 },
  fieldInput: { background: "var(--ibg)", border: "1px solid var(--bdr2)", borderRadius: 6, padding: "8px 10px", color: "var(--tx1)", fontSize: 13, outline: "none", fontFamily: "inherit", width: "100%", boxSizing: "border-box" },
  packageInfo: { fontSize: 11, color: "var(--tx2)", padding: "6px 10px", background: "rgba(56,189,248,0.06)", border: "1px solid rgba(56,189,248,0.15)", borderRadius: 6, lineHeight: 1.5 },
  ...
  valueLabel: { fontSize: 10, color: "var(--tx2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 4 },
  valueAmount: { fontSize: 22, fontWeight: 900, color: "#34d399", fontVariantNumeric: "tabular-nums" },
  valueDetail: { fontSize: 11, color: "var(--tx2)", marginTop: 2 },
  ...
  confirmNo: { background: "transparent", border: "1px solid var(--bdr2)", borderRadius: 6, padding: "6px 14px", fontSize: 12, color: "var(--tx2)", cursor: "pointer", fontFamily: "inherit" },
  newForm: { background: "var(--card)", border: "1px solid #a78bfa", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 8 },
  ...
  tipText: { fontSize: 12, color: "var(--tx1)", lineHeight: 1.6 },
};

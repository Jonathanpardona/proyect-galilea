            ...
            <div style={{ width: "100%", height: 220 }}>
              <ResponsiveContainer>
                <BarChart data={ultimos7} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <XAxis dataKey="label" tick={{ fill: c.muted, fontSize: 10 }} axisLine={{ stroke: c.border }} />
                  <YAxis tick={{ fill: c.muted, fontSize: 10 }} axisLine={{ stroke: c.border }} width={32} />
                  <Tooltip
  ...
  return (
    <div style={styles.newForm}>
      <div style={styles.newFormHeader}>
        <strong style={{ fontSize: 13, color: "var(--g-text)" }}>Nuevo registro</strong>
      ...
      <div style={{ fontSize: 11, color: "var(--g-text-muted)", marginTop: 4 }}>Exámenes (toca para seleccionar):</div>
      ...
      <div style={styles.inputRow}>
        <span style={{ color: "var(--g-text-muted)", fontSize: 12 }}>$</span>
...
const styles = {
  ...
  subtitle: { fontSize: 13, color: "var(--g-text-muted)", margin: "4px 0 1rem" },
  dateRow: { display: "flex", gap: 8, alignItems: "center", marginBottom: "1rem" },
  dateInput: { background: "var(--g-input-bg)", border: "1px solid var(--g-border)", borderRadius: 6, padding: "6px 10px", color: "var(--g-text)", fontSize: 13, outline: "none", fontFamily: "inherit", colorScheme: "light dark" },
  ...
  newForm: { background: "var(--g-surface)", border: "1px solid #38bdf8", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: 10 },
  newFormHeader: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  closeBtn: { background: "none", border: "none", color: "var(--g-text-muted)", fontSize: 22, cursor: "pointer", padding: 0, lineHeight: 1 },
  input: { background: "var(--g-input-bg)", border: "1px solid var(--g-border)", borderRadius: 6, padding: "8px 10px", color: "var(--g-text)", fontSize: 13, outline: "none", fontFamily: "inherit", width: "100%", boxSizing: "border-box" },
  inputRow: { position: "relative", display: "flex", alignItems: "center" },
  previsionalRow: { display: "flex", gap: 4 },
  prevBtn: { flex: 1, background: "var(--g-input-bg)", border: "1px solid var(--g-border)", borderRadius: 6, padding: "6px 8px", fontSize: 11, color: "var(--g-text-muted)", cursor: "pointer", fontFamily: "inherit", fontWeight: 600 },
  prevBtnActive: { background: "rgba(56,189,248,0.15)", borderColor: "#38bdf8", color: "#38bdf8" },
  examGrid: { display: "flex", flexWrap: "wrap", gap: 4 },
  examChip: { background: "var(--g-input-bg)", border: "1px solid var(--g-border)", borderRadius: 4, padding: "4px 8px", fontSize: 10, color: "var(--g-text-muted)", cursor: "pointer", fontFamily: "inherit" },
  ...
  regCard: { position: "relative", background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 10, padding: "0.75rem 0.9rem" },
  regTop: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10, marginBottom: 6 },
  regName: { fontSize: 13, fontWeight: 700, color: "var(--g-text)" },
  regMeta: { fontSize: 11, color: "var(--g-text-muted)", marginTop: 2 },
  ...
  confirmNo: { background: "transparent", border: "1px solid var(--g-border)", borderRadius: 5, padding: "3px 8px", fontSize: 10, color: "var(--g-text-muted)", cursor: "pointer", fontFamily: "inherit" },
  empty: { textAlign: "center", padding: "2rem", color: "var(--g-text-muted)", fontSize: 12, background: "var(--g-surface)", border: "1px dashed var(--g-border)", borderRadius: 10 },
  chartCard: { background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 12, padding: "1rem" },
  chartTitle: { fontSize: 13, fontWeight: 700, color: "var(--g-text)", marginBottom: "0.75rem" },
  weekSummary: { display: "flex", flexDirection: "column", gap: 4, marginTop: "1rem", paddingTop: "1rem", borderTop: "1px solid var(--g-surface)", fontSize: 12, color: "var(--g-text-muted)" },
  examCard: { background: "var(--g-surface)", border: "1px solid var(--g-border)", borderRadius: 12, padding: "1rem" },
  ...
  examName: { fontSize: 12, color: "var(--g-text)", marginBottom: 4 },
  examBar: { height: 4, background: "var(--g-border)", borderRadius: 2, overflow: "hidden" },

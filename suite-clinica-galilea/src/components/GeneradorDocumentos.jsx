              ...
              {DOCUMENTS.map((doc) => (
                <button key={doc.id} onClick={() => setSelected(doc.id)}
                  ...
                  <div style={{ flex: 1, textAlign: "left", minWidth: 0 }}>
                    <div style={{ ...styles.docTitle, color: selected === doc.id ? doc.color : "var(--tx1)" }}>
                      {doc.title}
                    </div>
...
const styles = {
  ...
  statsCard: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 10, padding: "0.85rem 1rem" },
  statsLabel: { fontSize: 10, color: "var(--tx2)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6 },
  statsRow: { display: "flex", alignItems: "center", gap: 10 },
  progressBar: { flex: 1, height: 6, background: "var(--bdr)", borderRadius: 3, overflow: "hidden" },
  ...
  formCard: { background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 12, padding: "1rem", display: "flex", flexDirection: "column", gap: "1.25rem" },
  section: { display: "flex", flexDirection: "column", gap: 8 },
  sectionTitle: { fontSize: 11, fontWeight: 700, color: "#a78bfa", textTransform: "uppercase", letterSpacing: "0.08em", paddingBottom: 6, borderBottom: "1px solid var(--bdr)" },
  ...
  fieldLabel: { fontSize: 10, color: "var(--tx2)", textTransform: "uppercase", letterSpacing: "0.04em", fontWeight: 600 },
  ...
  docCard: { display: "flex", alignItems: "center", gap: 12, padding: "0.75rem 0.9rem", background: "var(--card)", border: "1px solid var(--bdr)", borderRadius: 10, cursor: "pointer", color: "inherit", fontFamily: "inherit", transition: "all 0.2s" },
  docTitle: { fontSize: 13, fontWeight: 700, marginBottom: 2 },
  docDesc: { fontSize: 10, color: "var(--tx2)", lineHeight: 1.4 },
  actions: { display: "flex", gap: 8 },
  actionBtn: { flex: 1, background: "transparent", border: "1px solid var(--bdr2)", borderRadius: 8, padding: "10px 14px", fontSize: 12, color: "var(--tx2)", cursor: "pointer", fontWeight: 600, fontFamily: "inherit" },
  ...
  preview: { background: "var(--ibg)", border: "1px solid var(--bdr)", borderRadius: 12, padding: "1rem", maxHeight: "60vh", overflowY: "auto" },
  previewHeader: { display: "flex", alignItems: "center", gap: 8, paddingBottom: 8, marginBottom: 12, borderBottom: "1px solid var(--bdr)" },
  previewTitle: { fontSize: 12, color: "var(--tx1)" },
  previewText: { fontSize: 11, lineHeight: 1.6, color: "var(--tx2)", whiteSpace: "pre-wrap", margin: 0, fontFamily: "monospace" },
